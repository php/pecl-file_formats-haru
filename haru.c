...
PHP_MINIT_FUNCTION(haru)
{
	...
	HARU_CLASS_CONST(ce_harudoc, "GMODE_PAGE_DESCRIPTION", HPDF_GMODE_PAGE_DESCRIPTION);
	HARU_CLASS_CONST(ce_harudoc, "GMODE_TEXT_OBJECT", HPDF_GMODE_TEXT_OBJECT);
	HARU_CLASS_CONST(ce_harudoc, "GMODE_PATH_OBJECT", HPDF_GMODE_PATH_OBJECT);
	HARU_CLASS_CONST(ce_harudoc, "GMODE_CLIPPING_PATH", HPDF_GMODE_CLIPPING_PATH);
	HARU_CLASS_CONST(ce_harudoc, "GMODE_SHADING", HPDF_GMODE_SHADING);
	HARU_CLASS_CONST(ce_harudoc, "GMODE_INLINE_IMAGE", HPDF_GMODE_INLINE_IMAGE);
	HARU_CLASS_CONST(ce_harudoc, "GMODE_EXTERNAL_OBJECT", HPDF_GMODE_EXTERNAL_OBJECT);

	HARU_CLASS_CONST(ce_harupage, "LAYOUT_SINGLE", HPDF_PAGE_LAYOUT_SINGLE);
	HARU_CLASS_CONST(ce_harupage, "LAYOUT_ONE_COLUMN", HPDF_PAGE_LAYOUT_ONE_COLUMN);
	HARU_CLASS_CONST(ce_harupage, "LAYOUT_TWO_COLUMN_LEFT", HPDF_PAGE_LAYOUT_TWO_COLUMN_LEFT);
	HARU_CLASS_CONST(ce_harupage, "LAYOUT_TWO_COLUMN_RIGHT", HPDF_PAGE_LAYOUT_TWO_COLUMN_RIGHT);
	
	HARU_CLASS_CONST(ce_harupage, "MODE_USE_NONE", HPDF_PAGE_MODE_USE_NONE);
	HARU_CLASS_CONST(ce_harupage, "MODE_USE_OUTLINE", HPDF_PAGE_MODE_USE_OUTLINE);
	HARU_CLASS_CONST(ce_harupage, "MODE_USE_THUMBS", HPDF_PAGE_MODE_USE_THUMBS);
	HARU_CLASS_CONST(ce_harupage, "MODE_FULL_SCREEN", HPDF_PAGE_MODE_FULL_SCREEN);
